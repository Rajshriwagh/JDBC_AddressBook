...
public class AddressBookJDBC {
	public static void Read() {
		...
		try {
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Address_Book", "root", "root");

			Statement smt = connection.createStatement();
			ResultSet result = smt.executeQuery("select * from Address_book;");
	...
	public static void Update() {
		...
		try {
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Address_Book", "root",
					"root");
